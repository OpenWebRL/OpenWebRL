#!/bin/bash
# ==============================================================================
# Train Qwen3-VL-8B-Instruct for Browser Agent tasks.
#
...
SLIME_BROWSER_SANDBOX_MAX_SANDBOXES=80
...
DEFAULT_SAVE_DIR="${MODEL_ROOT}/${MODEL_NAME}_browser_rl_turn_bs32_0329_gpt4.1reward_maxstep15_img3_fixbs256_fixmultimodalinput_${RUN_TIMESTAMP}"
...
if [ -n "${WANDB_API_KEY}" ]; then
    WANDB_ARGS=(
        ...
        --wandb-group browser-qwen3vl-4b
...
# Megatron model type: Qwen3-VL-8B-Instruct → qwen3-8B
